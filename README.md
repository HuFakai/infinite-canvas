...
- AI 创作：支持 OpenAI 兼容、Gemini 和火山方舟协议的 Images API、Responses API、图生图、参考图编辑、流式接收、Base64 图片返回和文本问答。
...
- 画布图片工具：支持高分辨率裁剪、遮罩重绘、可拖拽切图、浏览器放大和真实 AI 超分，并可通过资源侧栏、节点组与多选导出整理画布。
